...
public class Possibilities {
    ...
    public void highlightAllRemaining() {
        for (int i = 0; i < 17; i++) {
            if (checker.returnValueOfLabel(i) == 0) {
                if (i == 6 ||i == 13 || i == 15 ||i == 16) {
                    controller.changeColor(i, Color.BLACK);
                } else {
                    controller.changeColor(i, Color.PURPLE);
                }
            }
        }
    }
